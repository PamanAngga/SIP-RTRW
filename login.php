			...
			<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
				<div class="panel panel-primary">
					<div class="panel-body">
						<img src="assets/img/sirtrw.png" class="user-image img-responsive" />
						<center>
							<h2>
								<b>SIP RT-RW</b>
							</h2>
...
<?php 
		if (isset($_POST['btnLogin'])) {  
            ...
            echo "<script>
                    Swal.fire({title: 'SUKSES',text: '',icon: 'success',confirmButtonText: 'OKE'
                    }).then((result) => {
                        if (result.value) {
            ...
            echo "<script>
                    Swal.fire({title: 'GAGAL',text: '',icon: 'error',confirmButtonText: 'OKE'
                    }).then((result) => {
                        if (result.value) {
