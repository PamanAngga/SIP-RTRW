			...
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					<li class="text-center">
						<img src="assets/img/sirtrw.png" class="user-image img-responsive" width="40%" />
					</li>
		...
		<div id="page-wrapper">
			<div id="page-inner">
				<div class="row">
					<div class="col-md-12">
						<marquee>
							<b>- SISTEM INFORMASI PENGADUAN RUKUN TETANGGA dan RUKUN WARGA | FITUR TAMBAHAN YANG ADA PADA APLIKASI INI MENGGUNAKAN
